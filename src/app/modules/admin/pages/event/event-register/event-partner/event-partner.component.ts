...
@Component({
  standalone: true,
  selector: 'admin-event-partner',
  styleUrl: './event-partner.component.scss',
  templateUrl: './event-partner.component.html',
  imports: [AppTableComponent, AppSelectComponent, FormsModule],
})
export class EventPartnerComponent {
  ...
  public getItems() {
    ...
    this.databaseService.eventPartner
      .getAll<any[]>()
      .then((response) => {
        console.log(response);
        this.pagination = {
